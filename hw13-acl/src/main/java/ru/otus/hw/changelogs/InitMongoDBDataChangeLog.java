...
public class InitMongoDBDataChangeLog {
    ...
    @ChangeSet(order = "005", id = "initUsers", author = "olgapima", runAlways = true)
    public void initUsers(UserRepository repository, PasswordEncoder passwordEncoder) {
        var admin = new User(null, "admin", passwordEncoder.encode("test"), List.of("ADMIN"));
        repository.save(admin);
        var user = new User(null, "user", passwordEncoder.encode("test"), List.of("USER"));
