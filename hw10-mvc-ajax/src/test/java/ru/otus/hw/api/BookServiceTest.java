...
//
//        Book testBook = bookService.save(new Book(testBookName, author, genre));
...
//                ).findFirst().get();
//
//        testedBook.setTitle(newTitle);
//        testedBook.setAuthor(newAuthor);
//        testedBook.setGenre(newGenre);
//
...
//        Long testBookId = bookService.findAll().get(0).getId();
...
//        Long bookId = commentRepository.findTopByOrderByIdAsc().getBook().getId();
