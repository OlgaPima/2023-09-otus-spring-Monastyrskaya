...
@ChangeLog(order = "001")
public class InitMongoTestDataChangeLog {
    ...
    public void initAuthors(AuthorRepository repository) {
        sKing = repository.save(new Author("1", "С. Кинг"));
        fKuper = repository.save(new Author("2", "Ф. Купер"));
        lTolstoy = repository.save(new Author("3", "Л.Н. Толстой"));
    }
